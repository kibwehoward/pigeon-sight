...
PigeonSight grew out of an inspection-oriented workflow problem. In the context of integrated pest management, surveying large or inaccessible sites pointed toward sUAS as a practical way to capture imagery for orthomosaics, point clouds, elevation models, and 3D reconstructions of habitats and structures. The tools to process that imagery existed. What did not exist was a process framework for managing that data reliably, repeatably, and without requiring either a proprietary subscription or deep systems-administration expertise.
